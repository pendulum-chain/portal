        ...
        <div class="container pt-16 px-6 h-full">
          <div className="flex flex-row-reverse h-15">
            ...
            <div class="dropdown dropdown-end mr-2">
              <button class="flex space-x-2 items-center px-4 py-2 btn no-animation">
                <span class={`${isPendulum ? 'text-white' : ''}  text-md`}>
                  {isPendulum ? 'Pendulum' : 'Amplitud'}
                </span>
                <svg xmlns="http://www.w3.org/2000/svg" style={{ width: 20, height: 20, marginLeft: 10, maxWidth: 15 }} viewBox="0 0 448 512">
                  <path fill={chevronColor} d="M224 416c-8.188 0-16.38-3.125-22.62-9.375l-192-192c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L224 338.8l169.4-169.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-192 192C240.4 412.9 232.2 416 224 416z" />
                </svg>
              </button>
