    ...
    messages: [
      {
        ...
        payable: false,
        returnType: {
          displayName: ['NablaCurve', 'params', 'return_type'],
          type: 3,
        },
        selector: '0xcff0ab96',
      },
      {
        ...
        default: false,
        docs: ['Calculates the output of the function Psi for input values b and l'],
        label: 'psi',
        mutates: false,
        payable: false,
        returnType: {
      ...
      },
      {
        ...
        default: false,
        docs: ['Given b,l and B >= Psi(b, l), this function determines the unique t>=0\nsuch that Psi(b+t, l+t) = B'],
