  ...
  spec: {
    ...
    messages: [
      ...
      },
      {
        ...
        default: false,
        docs: ['Set new upper limit of pool coverage ratio (reserves / liabilities) for swap-in'],
      ...
      },
      {
        ...
        default: false,
        docs: ['Get a quote for the effective amount of tokens for a deposit'],
        label: 'quoteDeposit',
        mutates: false,
        payable: false,
        returnType: {
      ...
      },
      {
        ...
        default: false,
        docs: ['Get a quote for the effective amount of tokens for a withdrawal'],
        label: 'quoteWithdraw',
        mutates: false,
        payable: false,
        returnType: {
      ...
      },
      {
        ...
        default: false,
        docs: ['Get a quote for the effective amount of tokens for a backstop drain'],
